...
(() => {
 ...
 const copy=document.getElementById('compta-copy-iban'); if(copy) copy.addEventListener('click',async()=>{try{await navigator.clipboard.writeText('900Z8057T432');toast('IBAN copié.')}catch{toast('IBAN : 900Z8057T432')}});
})();
